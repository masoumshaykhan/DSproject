...
class Menu:
    ...
    def customer_menu(situation):
        ...
        while temp:
            ...
            service = temp.find_id(int(key.strip()))
            ...
            # ****MANAGER MENU****
                ...
                if key == 1:
                    ...
                    while temp:
                        ...
                        while temp2:
                            ...
                            temp2 = temp2.next
                        if delete:
                            to_delete = temp.find_id(int(service_id_to_delete))
                            print(" TO DELETE :", to_delete)
                            if to_delete and to_delete.parent is not None:
                ...
                if key == 1:
                    ...
                    while index:
                        ...
                        index -= 1
                        temp = temp.next
                    selected.traverse(False)
                    parent = input("enter parent service name:")
                    parent_service = selected.find(parent)
                    ...
                    if parent_service is not None:
                        parent_service.add_child(service)
                elif key == 0:
                    situation = "SERVICES"
...
if __name__ == "__main__":
    ...
    root = Service(1, "a", "pride", "customer_description", "technical_description", "expense")
    child2 = Service(11, "b", "pride", "customer_description2", "technical_description2", "expense2")
    child2.parent = root
    root.add_child(child2)
    child4 = Service(111, "b1", "pride", "customer_description4", "technical_description4", "expense4")
    child4.parent = child2
    child2.add_child(child4)
    child3 = Service(112, "b2", "pride", "customer_description3", "technical_description3", "expense3")
    child3.parent = child2
    child2.add_child(child3)
    child1 = Service(12, "c", "pride", "customer_description1", "technical_description1", "expense1")
    child1.parent = root
    root.add_child(child1)
    child5 = Service(113, "b3", "pride", "customer_description5", "technical_description5", "expense5")
    child5.parent = child2
    child2.add_child(child5)
    child6 = Service(121, "c1", "pride", "customer_description5", "technical_description5", "expense5")
    ...
    new_service = Service(9, "b", "p", "customer_description5", "technical_description5", "expense5")
    t.add_sub_service("a", new_service)
    # t.traverse()
    s.add_service_last(t)
    print("\n ****\n")
    roott = Service(2, "aa", "pride", "customer_description", "technical_description", "expense")
    childd2 = Service(21, "bb", "pride", "customer_description2", "technical_description2", "expense2")
    childd2.parent = roott
    roott.add_child(childd2)
    childd4 = Service(211, "bb1", "pride", "customer_description4", "technical_description4", "expense4")
    childd4.parent = childd2
    childd2.add_child(childd4)
    childd3 = Service(212, "bb2", "pride", "customer_description3", "technical_description3", "expense3")
    childd3.parent = childd2
    childd2.add_child(childd3)
    childd1 = Service(22, "cc", "pride", "customer_description1", "technical_description1", "expense1")
    childd1.parent = roott
    roott.add_child(childd1)
    childd5 = Service(213, "bb3", "pride", "customer_description5", "technical_description5", "expense5")
    childd5.parent = childd2
    childd2.add_child(childd5)
    childd6 = Service(221, "cc1", "pride", "customer_description5", "technical_description5", "expense5")
